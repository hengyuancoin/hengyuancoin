...
This document provides guidelines for internationalization of the Hycoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hycoin_en.ts` remains unchanged.
