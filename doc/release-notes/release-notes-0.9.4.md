Hycoin Core version 0.9.4 is now available from:

  https://hycoin.org/bin/0.9.4/
...
this update is incompatible with the Hycoin system and could lead to consensus
forks.

Hycoin Core released binaries from https://hycoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hycoin/+archive/ubuntu/hycoin
- A third-party or self-compiled Hycoin Core

upgrade to Hycoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
