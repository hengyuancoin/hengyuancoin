Hycoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hycoin/files/Hycoin/hycoin-0.5.4/
...
http://gitorious.org/hycoin/hycoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Hycoin-Qt notifications under Growl 1.3.
Increase required age of Hycoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHycoin properly when installing Hycoin-Qt over it. (Windows)
