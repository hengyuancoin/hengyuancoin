Hycoin Core version 0.9.2.1 is now available from:

  https://hycoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HYC to 0.01 HYC
...
- Fix "Start hycoin on system login"
