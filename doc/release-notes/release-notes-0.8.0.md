Hycoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hycoin/files/Hycoin/hycoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Hycoin
...
New/changed settings (command-line or hycoin.conf file)
--------------------------------------------------------
