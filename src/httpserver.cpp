// Copyright (c) 2015 The Ecccoin Core developers
...
{
    RenameThread("ecccoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/ecccoin/ecccoin/pull/6990)
...
void HTTPRequest::WriteReply(int nStatus, const std::string& strReply)
{
	...
	char szbuf[100] = {0};
	itoa(strReply.length(), szbuf, 10);
	evhttp_add_header(headers, "Content-Length", szbuf);
