/* src/config/hycoin-config.h.  Generated from hycoin-config.h.in by configure.  */
/* src/config/hycoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HYCOIN_CONFIG_H

#define HYCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/hycoin/hycoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hycoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hycoin Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hycoin"
