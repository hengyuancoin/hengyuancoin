...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/hycoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Hycoin Core"),
     ...
     * override -datadir in the hycoin.conf file in the default data directory
     * (to be consistent with hycoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
