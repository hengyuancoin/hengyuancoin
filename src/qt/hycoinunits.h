...
#ifndef HYCOIN_QT_HYCOINUNITS_H
#define HYCOIN_QT_HYCOINUNITS_H
...
/** Hycoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HycoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HycoinUnits(QObject *parent);

    /** Hycoin units.
      @note Source: https://en.hycoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        HYC,
...
typedef HycoinUnits::Unit HycoinUnit;

#endif // HYCOIN_QT_HYCOINUNITS_H
