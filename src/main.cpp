...
#if defined(NDEBUG)
# error "Hycoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Hycoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s HYC additional fees, %d delta bytes\n",
