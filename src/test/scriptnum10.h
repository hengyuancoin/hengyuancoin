...
#ifndef HYCOIN_TEST_SCRIPTNUM10_H
#define HYCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hycoin Core 0.10.0, for cross-comparison.
 */
public:
