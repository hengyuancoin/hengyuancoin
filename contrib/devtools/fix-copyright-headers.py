...
// Copyright (c) 2009-2012 The Hycoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Hycoin/$1-%s The Hycoin/' %s"
REGEX_CURRENT= re.compile("%s The Hycoin" % year)
