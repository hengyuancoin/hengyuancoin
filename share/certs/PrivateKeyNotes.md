...
unlocked to sign the Hycoin-Qt.app bundle.
...
allowing somebody to distribute a Hycoin-Qt.app or hycoin-qt-setup.exe with a valid
...
that the hycoin-qt.exe file inside the installer had not been tampered with.
